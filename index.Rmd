...
### Classification 
```{r, fig.width=9}
combined_knn %>% get_conf_mat() %>% autoplot(type = "mosaic") + scale_colour_brewer(
...
On the left the mosaic plot shows the results, after 10-fold cross-validation of a k = 1 nearest neighbour classifier trained with the features list. 
...
![Wrapped playlist 2018](images/2018.png)
