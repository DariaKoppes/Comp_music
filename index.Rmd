...
#### The mood of the songs compared
...
scatterplotbillie <- billie %>%
  ...
  plot.title = element_text(size=10, margin = margin(25, 0, 25, 0), 
  hjust = 0.5), 
  legend.key = element_rect(fill = "#e7e7e4")
) + 
  annotate("text", x = 0.1, y = 0.05, 
...
fig <- ggplotly(scatterplotbillie)
