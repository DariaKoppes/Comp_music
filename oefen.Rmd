...
```{r}
sixteen <- get_playlist_audio_features("", "37i9dQZF1CyQSI4FeH8uRR")
seventeen <- get_playlist_audio_features("", "37i9dQZF1E9YeRFOdYZT1f")
...
combined <-
  bind_rows(
    sixteen %>% mutate(category = "Wrapped playlist 2016"),
    seventeen %>% mutate(category = "Wrapped playlist 2017"),
